...
all       | bool    |         | парсер собирает новые статьи. работает если articles = true и best = false
`         |         | true    | 
`         |         | false   |  
...
`         |         | 100     | оценка выше 100  
`         |         | empty   | без порога            
best      | bool    |         | парсер собирает лучшие статьи. работает если articles = true и all = false 
`         |         | true    |        
`         |         | false   |                                                      
