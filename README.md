...
Тестовое задание для https://tochka.com/ 🙃
...
-         |         | true    | парсер собирает статьи с сайта
-         | -       | false   | парсер собирает последние новости с сайта
          |         |         |
all       | bool    |         | парсер собирает новые статьи
-         | -       | true    | ставится, если articles = true и best = false
-         | -       | false   |  
rating    | string  |         | оценка статьи. можно не указывать, тогда парсер будет собирать рандомные статьи
-         | -       | top10   | оценка выше 10
-         | -       | top25   | оценка выше 25 
-         | -       | top50   | оценка выше 50 
-         | -       | top100  | оценка выше 100           
best      | bool    |         | проставляется, если articles = true и all = false. парсятся лучшие статьи
-         | -       | true    | ставится, если articles = true и all = false        
-         | -       | false   |                                                      
...
-         | -       | "Смартфоны"   | 
-         | -       | "Медицина"    |           
-         | -       | "Прочее"      | P.S.: Категорий на сайте больше, я взяла эти для примера          
          |         |               |
